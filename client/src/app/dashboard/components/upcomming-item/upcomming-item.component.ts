...
@Component({
  selector: 'app-upcomming-item',
  templateUrl: './upcomming-item.component.html',
  styleUrls: ['./upcomming-item.component.scss']
})
export class UpcommingItemComponent implements OnInit {
